...
import { ArrowRight, Heart, BookOpen, Calendar, ShoppingBag } from "lucide-react"
...
export function ServicesSection() {
  ...
  return (
    <Section className="bg-background dark:bg-[#0b0b0c] pt-24 md:pt-32 pb-16 md:pb-20 transition-colors duration-500 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <Link 
            ...
            onClick={(e) => {
              if (window.location.pathname === "/") {
                e.preventDefault();
                document.getElementById("soulmar-brand")?.scrollIntoView({ behavior: "smooth" });
              }
            }}
          >
